...
App web em Python (Flask) que mostra um bichinho-planta animado que muda o humor de acordo com as leituras do Arduino (`PetPlantaARDUINO.ino`): luz, umidade
...
## 3. Calibrar os limites (thresholds)
...
## 4. Estado crítico (LED + buzzer de alarme)
...
## 4.1. LEDs de status (verde/amarelo/vermelho)
...
## 5. Tela de configurações (editar limiares pelo navegador)
...
## 7. Painel de simulação (controlar os dados fictícios)
